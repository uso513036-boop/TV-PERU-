...
object ChannelRepository {
    ...
    val channels = listOf(
        Channel(
            ...
            backupStreamUrl = "http://187.102.210.46/TVPERU/index.m3u8",
            logoText = "TVP",
        ...
        Channel(
            ...
            streamUrl = "http://190.93.224.42/AMERICA-TV/index.m3u8",
            backupStreamUrl = "http://187.102.210.46/AMERICA/index.m3u8",
            logoText = "AMÉ",
        ...
        Channel(
            ...
            backupStreamUrl = "http://187.102.210.46/PANAMERICANA/index.m3u8",
            logoText = "PAN",
        ...
        Channel(
            ...
            streamUrl = "http://190.93.224.42/WILLAX/index.m3u8",
            backupStreamUrl = "http://187.102.210.46/WILLAX/index.m3u8",
            logoText = "WLX",
        ...
        Channel(
            ...
            backupStreamUrl = "http://187.102.210.46/IPE/index.m3u8",
            logoText = "IPE",
        ...
        Channel(
            ...
            backupStreamUrl = "http://187.102.210.46/EXITOSA/index.m3u8",
            logoText = "EXI",
        ...
        Channel(
            ...
            category = ChannelCategory.NOTICIAS,
            streamUrl = "http://190.93.224.42/TV-PERU-NOTICIAS/index.m3u8",
            backupStreamUrl = "https://rpp-live.streamguys1.com/rpp/playlist.m3u8",
            logoText = "RPP",
        ...
        Channel(
            ...
            streamUrl = "https://5a92e1b1567bc.streamlock.net/congresotv/smil:congresotv.smil/playlist.m3u8",
            backupStreamUrl = "http://190.93.224.42/TV-PERU/index.m3u8",
            logoText = "CON",
        ...
        Channel(
            ...
            category = ChannelCategory.ENTRETENIMIENTO,
            streamUrl = "http://190.93.224.42/VIVA-TV/index.m3u8",
            backupStreamUrl = "http://190.93.224.42/TV-PERU/index.m3u8",
            logoText = "VIV",
